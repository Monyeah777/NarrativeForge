...
> 覆盖：12 个包内概念 + 11 个**可扩展标准节点**（主锚/辅锚/依赖三层入图：概念 → 主锚、概念 → 辅锚、标准依赖边）+ 1 个包外前置族（B12-00 领域通用前置）；节点 23 · 边 40 · 密度 1.7391。
...
| `STD-commonmark` | 标准 · CommonMark 0.31.2（CommonMark｜form｜实测 ✓） | P80 | `B12-01`、`B12-03`、`B12-07`、`B12-09`、`B12-11`、`B12-12` | std-catalog |
| `STD-ietf-bcp47` | 标准 · 语言标签 (RFC 5646)（IETF｜gov｜实测 ✓） | P80 | — | std-catalog |
| `STD-ietf-json` | 标准 · JSON (RFC 8259)（IETF｜data｜实测 ✓） | P80 | — | std-catalog |
| `STD-ietf-json-schema` | 标准 · JSON Schema 2020-12（IETF/JSON Schema｜data｜实测 ✓） | P80 | `B12-02`、`B12-06`、`B12-08`、`B12-10`、`STD-ietf-json` | std-catalog |
| `STD-rdf11` | 标准 · RDF 1.1（W3C｜data｜实测 ✓） | P80 | — | std-catalog |
| `STD-vega-lite` | 标准 · Vega-Lite v5（Vega｜form｜实测 ✓） | P80 | `B12-02`、`B12-05`、`B12-08`、`B12-10`、`STD-ietf-json-schema` | std-catalog |
| `STD-w3c-epub33` | 标准 · EPUB 3.3（W3C｜form｜实测 ✓） | P80 | `B12-09`、`B12-12`、`STD-w3c-xml` | std-catalog |
| `STD-w3c-mathml3` | 标准 · MathML 3（W3C｜form｜实测 ✓） | P80 | `B12-04`、`STD-w3c-xml` | std-catalog |
| `STD-w3c-prov-o` | 标准 · PROV-O 溯源本体（W3C｜gov｜实测 ✓） | P80 | `B12-04`、`STD-rdf11` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C｜data｜实测 ✓） | P80 | `B12-01`、`B12-03`、`B12-05`、`B12-07`、`B12-11`、`B12-06`、`STD-ietf-bcp47` | std-catalog |
