...
> 覆盖：12 个包内概念 + 4 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（B12-00 领域通用前置）。
...
| `STD-ietf-json-schema` | 标准 · JSON Schema 2020-12（IETF/JSON Schema） | P80 | `B12-02`、`B12-06`、`B12-08`、`B12-10` | std-catalog |
| `STD-w3c-epub33` | 标准 · EPUB 3.3（W3C） | P80 | `B12-09`、`B12-12` | std-catalog |
| `STD-w3c-mathml3` | 标准 · MathML 3（W3C） | P80 | `B12-04` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `B12-01`、`B12-03`、`B12-05`、`B12-07`、`B12-11` | std-catalog |
