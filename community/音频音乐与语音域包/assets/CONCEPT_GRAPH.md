...
> 覆盖：12 个包内概念 + 4 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（E09-00 领域通用前置）。
...
| `STD-commonmark` | 标准 · CommonMark 0.31.2（CommonMark） | P80 | `E09-01`、`E09-07` | std-catalog |
| `STD-w3c-epub33` | 标准 · EPUB 3.3（W3C） | P80 | `E09-03`、`E09-06`、`E09-09` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `E09-05`、`E09-08`、`E09-11` | std-catalog |
| `STD-w3c-webaudio` | 标准 · Web Audio API（W3C） | P80 | `E09-02`、`E09-04`、`E09-10`、`E09-12` | std-catalog |
