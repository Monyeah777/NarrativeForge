...
> 覆盖：12 个包内概念 + 4 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（E19-00 领域通用前置）。
...
| `STD-commonmark` | 标准 · CommonMark 0.31.2（CommonMark） | P80 | `E19-01`、`E19-04`、`E19-10` | std-catalog |
| `STD-nist-ai-rmf` | 标准 · AI 风险管理框架（NIST） | P80 | `E19-07` | std-catalog |
| `STD-w3c-epub33` | 标准 · EPUB 3.3（W3C） | P80 | `E19-03`、`E19-06`、`E19-09`、`E19-12` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `E19-02`、`E19-05`、`E19-08`、`E19-11` | std-catalog |
