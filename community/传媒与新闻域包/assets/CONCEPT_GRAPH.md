...
> 覆盖：12 个包内概念 + 5 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（D17-00 领域通用前置）。
...
| `STD-creativecommons` | 标准 · 许可与权利表达（Creative Commons） | P80 | `D17-09` | std-catalog |
| `STD-iso-iec-25010` | 标准 · SQuaRE 质量模型（ISO/IEC） | P80 | `D17-03`、`D17-06`、`D17-12` | std-catalog |
| `STD-nist-ai-rmf` | 标准 · AI 风险管理框架（NIST） | P80 | `D17-01`、`D17-04`、`D17-07` | std-catalog |
| `STD-vega-lite` | 标准 · Vega-Lite v5（Vega） | P80 | `D17-10` | std-catalog |
| `STD-w3c-prov-o` | 标准 · PROV-O 溯源本体（W3C） | P80 | `D17-02`、`D17-05`、`D17-08`、`D17-11` | std-catalog |
