...
> 覆盖：12 个包内概念 + 7 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（D08-00 领域通用前置）。
...
| `STD-frictionless-table` | 标准 · Table Schema（Frictionless） | P80 | `D08-05`、`D08-12` | std-catalog |
| `STD-iso-iec-25010` | 标准 · SQuaRE 质量模型（ISO/IEC） | P80 | `D08-06` | std-catalog |
| `STD-nist-ai-rmf` | 标准 · AI 风险管理框架（NIST） | P80 | `D08-01`、`D08-04`、`D08-10` | std-catalog |
| `STD-owasp-llm` | 标准 · LLM 应用十大风险（OWASP） | P80 | `D08-09` | std-catalog |
| `STD-spdx-3` | 标准 · SPDX 3.0（含 AI profile）（SPDX） | P80 | `D08-07` | std-catalog |
| `STD-w3c-prov-o` | 标准 · PROV-O 溯源本体（W3C） | P80 | `D08-02`、`D08-08`、`D08-11` | std-catalog |
| `STD-w3c-svg2` | 标准 · SVG 2（W3C） | P80 | `D08-03` | std-catalog |
