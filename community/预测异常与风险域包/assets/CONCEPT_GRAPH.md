...
> 覆盖：12 个包内概念 + 7 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（B18-00 领域通用前置）。
...
| `STD-cncf-otel-semconv` | 标准 · 语义约定（可扩展注册表）（OpenTelemetry） | P80 | `B18-11` | std-catalog |
| `STD-frictionless-table` | 标准 · Table Schema（Frictionless） | P80 | `B18-03`、`B18-06`、`B18-09` | std-catalog |
| `STD-gips` | 标准 · GIPS 绩效标准（CFA Institute） | P80 | `B18-05`、`B18-10` | std-catalog |
| `STD-ietf-json-schema` | 标准 · JSON Schema 2020-12（IETF/JSON Schema） | P80 | `B18-04`、`B18-07` | std-catalog |
| `STD-onnx` | 标准 · ONNX（opset 扩展）（Linux Foundation） | P80 | `B18-12` | std-catalog |
| `STD-w3c-owl-time` | 标准 · OWL-Time 时间本体（W3C） | P80 | `B18-01` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `B18-02`、`B18-08` | std-catalog |
