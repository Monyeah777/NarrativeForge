...
> 覆盖：12 个包内概念 + 7 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（B05-00 领域通用前置）。
...
| `STD-cncf-cloudevents` | 标准 · CloudEvents 1.0（CNCF） | P80 | `B05-03` | std-catalog |
| `STD-frictionless-table` | 标准 · Table Schema（Frictionless） | P80 | `B05-06` | std-catalog |
| `STD-ietf-json-schema` | 标准 · JSON Schema 2020-12（IETF/JSON Schema） | P80 | `B05-01`、`B05-04`、`B05-07`、`B05-10` | std-catalog |
| `STD-mlcommons-bench` | 标准 · MLPerf 基准（可扩展场景）（MLCommons） | P80 | `B05-11`、`B05-12` | std-catalog |
| `STD-rdf11` | 标准 · RDF 1.1（W3C） | P80 | `B05-02` | std-catalog |
| `STD-w3c-skos` | 标准 · SKOS 词表（W3C） | P80 | `B05-09` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `B05-05`、`B05-08` | std-catalog |
