...
> 覆盖：12 个包内概念 + 5 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（C07-00 领域通用前置）。
...
| `STD-cncf-otel-semconv` | 标准 · 语义约定（可扩展注册表）（OpenTelemetry） | P80 | `C07-07` | std-catalog |
| `STD-mermaid` | 标准 · Mermaid 图语言（Mermaid） | P80 | `C07-01` | std-catalog |
| `STD-mlcommons-bench` | 标准 · MLPerf 基准（可扩展场景）（MLCommons） | P80 | `C07-02`、`C07-03`、`C07-05`、`C07-08`、`C07-09`、`C07-10`、`C07-11`、`C07-12` | std-catalog |
| `STD-onnx` | 标准 · ONNX（opset 扩展）（Linux Foundation） | P80 | `C07-04` | std-catalog |
| `STD-owasp-llm` | 标准 · LLM 应用十大风险（OWASP） | P80 | `C07-06` | std-catalog |
