...
> 覆盖：12 个包内概念 + 6 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（B03-00 领域通用前置）。
...
| `STD-frictionless-table` | 标准 · Table Schema（Frictionless） | P80 | `B03-03`、`B03-06`、`B03-09`、`B03-11` | std-catalog |
| `STD-gdpr` | 标准 · GDPR（EU） | P80 | `B03-12` | std-catalog |
| `STD-ietf-json-schema` | 标准 · JSON Schema 2020-12（IETF/JSON Schema） | P80 | `B03-01`、`B03-10` | std-catalog |
| `STD-oci-image` | 标准 · 镜像清单（OCI） | P80 | `B03-04` | std-catalog |
| `STD-w3c-skos` | 标准 · SKOS 词表（W3C） | P80 | `B03-02`、`B03-07` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `B03-05`、`B03-08` | std-catalog |
