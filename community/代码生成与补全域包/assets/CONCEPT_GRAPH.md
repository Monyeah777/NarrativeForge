...
> 覆盖：12 个包内概念 + 5 个**可扩展标准节点**（标准目录绑定）+ 1 个包外前置族（B08-00 领域通用前置）。
...
| `STD-creativecommons` | 标准 · 许可与权利表达（Creative Commons） | P80 | `B08-10` | std-catalog |
| `STD-frictionless-table` | 标准 · Table Schema（Frictionless） | P80 | `B08-03`、`B08-09`、`B08-12` | std-catalog |
| `STD-ietf-json-schema` | 标准 · JSON Schema 2020-12（IETF/JSON Schema） | P80 | `B08-01`、`B08-04`、`B08-07` | std-catalog |
| `STD-oasis-openapi` | 标准 · OpenAPI 3.1（OpenAPI Initiative） | P80 | `B08-06`、`B08-11` | std-catalog |
| `STD-w3c-tabular-data` | 标准 · Tabular Data Model (CSVW)（W3C） | P80 | `B08-02`、`B08-05`、`B08-08` | std-catalog |
