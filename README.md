...
`verify v2.26 · check1-36 · PASS=59` · `python scripts/nf.py --version`

## ⚡ 如果你是 AI / Agent

- 这是什么：规范驱动的文档工厂，装模块/管线/资产 → 校验 → 输出。
- 入口链：`AGENT_START.md`（开工）→ `AI_ROUTING.md`（选线）→ `DEEP_DIVE.md`（懂得深）。
- 机器凭证：`bash verify.sh` → v2.26，check1-36，PASS=59。
...
44 模块 · 8 管线 · 5 社区包 · 55 资产档/165 键 · world_model 1（M50） · 馆藏 2 件 · 实践包 3 条 · verify check1-36 常驻
