...
|---|---|---|---|---|---|---|---|
| NF-1 | 校园情感流（高二 · 毕业遗憾线） | 世界（校园情感装配样本） | NarrativeForge（NF）作者 | 2026-09-06 | MIT | active | 官方装配样本：P02 校园情感管线 + 幽灵遗憾模块（引用式档位，示范诚实纪律） |
| NF-TECHDOC-Monyeah777-1 | 技术文档装配流 P06 · 自包含完整版 | 技术文档装配（自包含完整版） | Monyeah777 | 2026-09-15 | MIT | active | 技术文档域包 P06 装配的自包含完整版——15 件模块正文与管线声明全文内嵌、零资产、无需仓库路径即可装载开跑 |
| NF-WORLDCAMPUS-Monyeah777-1 | 雨天走廊·氛围包 | 世界（短篇场景包） | Monyeah777 | 2026-09-07 | 未声明 | active | 雨天走廊氛围设定包——可直接生成场景/开场/转场 |
