...
| v1.2.0 | 协议中转站 v2 | 🔵 开发中（已实现） | IR 内容归一化层（2.0 E0-①） | 14_v1.2.0_协议中转站v2方案.md |
| v1.3.0 | Agentic 检索 | 🔵 开发中（已实现） | 四类对象统一检索（2.0 E0-②） | 15_v1.3.0_Agentic检索方案.md |
| v1.4.0 | 质量治理闭环 | 🔵 开发中（已实现） | 质检门+check17（2.0 E0-③） | 16_v1.4.0_质量治理闭环方案.md |
| v2.0.0 | 导出层 CCV3 | 🔵 开发中（已实现） | CCV3 首发+插件架构（2.0 E1） | 17_v2.0.0_导出层CCV3方案.md |
| v2.0.x | 插件出口序列 | 🔮 规划 | SKILL 已交付；AGENTS/MCP 按战例纪律增补 | 18_v2.0x_SKILL出口插件方案.md |
