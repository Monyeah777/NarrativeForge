...
| v2.4.0 | 外部吸收大包 | 🔵 主线执行中（方案 35） | 规范核查三连（SKILL/CCV3/AGENTS）+ 实现四件（A4 check22 体检 / A5 nf rename / A6 质量分级 / A7 上架元数据） | 35 方案文档（§7.5 展开） |
