...
DOMAIN = ['community/校园情感领域包', 'community/西幻生存领域包', 'community/大语言模型域包', 'community/多模态大模型域包', 'community/视觉模型域包', 'community/语音识别与合成域包', 'community/音频与音乐生成域包', 'community/视频生成与理解域包', 'community/图像生成与编辑域包', 'community/文本生成与创作域包', 'community/摘要与信息压缩域包', 'community/机器翻译与本地化域包', 'community/分类与情感分析域包', 'community/代码大模型域包', 'community/嵌入与检索表示域包', 'community/具身智能与机器人域包']
