...
#        [段 C] 代码层门禁（check12-check28，无条件执行：分层治理 23 方案——本段默认锁 L0-L2；
...
# ================= 主执行体（三段式） =================
echo '=================================================='
echo ' NarrativeForge 三段式验收门禁  v2.17（对齐 07 §7 + 08 T5 A5 资产对账 + 09 v0.6.0 check12 代码层 + check13 迁移完整性 + 10 v0.7.0 check14 社区协议登记门禁 + 11 v0.8.0 check15 组合引用门禁 + 12 v1.0.0 check16 契约仲裁门禁 + 16 v1.4.0 check17 质量治理门 + 17 v2.0.0 check18 导出契约门 + 33 v2.2.0 check19-21 外部吸收首波 + 35 v2.4.0 check22 规范体检；分层治理 23 方案：L3 端壳冻结移出，门禁默认锁 L0-L2）'
echo '=================================================='
...
echo '—— 段 C：代码层门禁（L2 core：check12-check28 无条件执行；android 相关已随 L3 冻结移出）——'
check12
check13
check14
check15
